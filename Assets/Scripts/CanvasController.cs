...
public class CanvasController : MonoBehaviour
{
    ...
    private void Awake()
    {
        if(resources == null || resources.Count == 0) throw new System.Exception("Le canvas controller n'a pas de resource à afficher!");
        if(buildings == null || buildings.Count == 0) throw new System.Exception("Le canvas controller n'a pas de building à afficher!");
